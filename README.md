...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aproc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14451&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aproc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aproc` can be installed with:

```
conda install aproc
```

It is possible to list all of the versions of `aproc` available on your platform with:
